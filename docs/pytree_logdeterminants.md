...
# Look at the Jacobian -- oh no, they are pytree-valued
print(f0)
print(jvp(x0))
print(vjp(f0))

# To compute log-determinants, we need to transform:
# This transformation is "ravelling" (think: flattening of the tree).
